...
Здесь два хоста, на каждом работает Nginx, который посредством fastcgi обеспечивает работу web-приложения Roundcube.
...
Для обеспечения отказоустойчивости на хостах поднят виртуальный ip-адрес посредством keepalived в режиме active/backup.
