...
В появившихся после обновления полях вводим Setup password (по умолчанию postfix2020), логин администратора почтовой системы (в формате email-адреса) и его пароль:
...
После чего попадаем в консоль управления системой, где есть возможность создавать домены, почтовые ящики и алиасы и производить их настройку.
...
Теперь почтовая система одного ящика готова, можно авторизовываться в roundcube:
