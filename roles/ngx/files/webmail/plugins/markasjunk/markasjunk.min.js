...
rcube_webmail.prototype.markasjunk_move=function(a,c){var b=this.env.uid;this.message_list&&1==c.length&&!this.message_list.in_selection(c[0])&&(this.env.uid=c[0]);a?this.move_messages(a):!0==this.env.markasjunk_permanently_remove?this.permanently_remove_messages():this.delete_messages();this.env.uid=b};
