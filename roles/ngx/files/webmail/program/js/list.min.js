...
null},highlight_row:function(a,b,c){if(this.rows[a])if(b){var d;d=this.in_selection(a,!0);!1===d?(this.selection.push(a),$(this.rows[a].obj).addClass("selected").attr("aria-selected","true"),this.checkbox_selection&&$(".selection > input",this.rows[a].obj).prop("checked",!0),c||this.rows[a].expanded||this.highlight_children(a,!0)):(b=this.selection.slice(0,d),d=this.selection.slice(d+1,this.selection.length),this.selection=b.concat(d),$(this.rows[a].obj).removeClass("selected").removeAttr("aria-selected"),
